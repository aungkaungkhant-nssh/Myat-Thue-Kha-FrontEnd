...
function ProductDetail() {
   ...
   const startOrder =()=>{
        dispatch(startOrderItems({qty,...product}));
                        ...
                        <div className="container">
                            <div className="row text-center text-lg-left">
                                <div className='col-lg-4 col-12'>
                                    <div>
                                        <img src={`https://myatthuekha-online-medicine.herokuapp.com/${product.image}`} alt="" style={{width:"60%"}}/>
                                    </div>
                                </div>
                                <div className='col-lg-4 col-12'>
                                    <div>
                                                                ...
                                                                <div className='d-flex align-items-center'>
                                                                    <div className='mr-5'>
                                                                        <div className='d-flex justify-content-center align-items-center'>
                                                                            <img src={`https://myatthuekha-online-medicine.herokuapp.com/${review.image}`} style={{width:"70px",borderRadius:"100%"}} className="mr-3" />
                                                                            <div>
