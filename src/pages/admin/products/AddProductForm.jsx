...
function AddProductForm() {
  ...
  const submitHandler = (e)=>{
    e.preventDefault();
    if(isEdit){
      dispatch(updateProductForAdminPannel({id:productId,name,categoryId,price,numberInstock,image,description}));
      return;
    }
    dispatch(createProductForAdminPannel({name,categoryId,price,numberInstock,image,description}))
  }
                    ...
                    :(
                      <form onSubmit={submitHandler}>
                        ...
                        <div className='form-group'>
                          ...
                          <select 
                              value={categoryId}
                              className={`form-control ${validationErrors.find((v)=> v.param === "category_id") && classes.validations}`}
                          ...
                          <ValidationErrorMsg validationErrors={validationErrors} inputField="category_id"/>
                        </div>
                        <div className='form-group'>
                        ...
                        </div>
                        {
                          isEdit && image && (
                            <div className='form-group mb-2'>
                              <img  src={"https://myatthuekha-online-medicine.herokuapp.com/"+ image  } alt="" />
                            </div>
                          )
                        }
